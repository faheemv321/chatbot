...
def chat():
	...
	trans_msg = translate_api(user_message,"hi-en")
	...
	response = rasa(trans_msg)
	
	#print("ENG RESPONSE : ",response)

	trans_response = translate_api(response,"en-hi")
	
	#print("TRANSLATED RESPONSE : ",trans_response)
	
	return jsonify({"status":"success","response":trans_response})
